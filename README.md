...
use this one for example, but it contains a lot of garbage words like 'aam' or 'abama' and many more that are not
...
you're playing hellowordl instead, you can change the word length by moving the Word Length slider, all lengths from 4
to 11 are supported.
