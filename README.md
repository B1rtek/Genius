...
use [this one](https://github.com/dwyl/english-words/blob/master/words.txt) for example, but it contains a lot of garbage words like 'aam' or 'abama' and many more that are not
